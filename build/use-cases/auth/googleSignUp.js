...
const getUserAccountFromGoogle = (accessToken_1, ...args_1) => __awaiter(void 0, [accessToken_1, ...args_1], void 0, function* (accessToken, url = null) {
...
const googleSignUp = (authCode) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = yield (0, exports.getAccessToken)(authCode);
    // use access token to get user account info
    const { names, emailAddresses, photos, phoneNumbers, birthdays, genders } = yield (0, exports.getUserAccountFromGoogle)(accessToken);
